    ...
    <div className="programa container ">
      ...
      <div className="programa__programa">
        ...
        <p className="programa__content">
          ...
          actores estamos llamados a hacer un esfuerzo común para responder ante
          este desafío. Un esfuerzo común que nos permita construir un presente
          y un futuro con oportunidades de desarrollo para todos los miembros de
          nuestra sociedad.
          <br></br>
          <br></br>
            ...
            <p>
              ...
              <span className="programa__oradores">
                <ul>
                  ...
                  <li>
                    <span className="programa__evento">•</span>{" "}
                    <span className="programa__orador__nombre">Joan Melé.</span>{" "}
