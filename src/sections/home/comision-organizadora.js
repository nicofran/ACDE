          ...
          <Integrante
            ...
            biografia={
              <React.Fragment>
                ...
                Andrés, Di Tella y Cedes. Es Directora Ejecutiva de ACDE desde
                abril de 2016, habiendo ingresado en 2015 como consultor.
                Colabora con diferentes Organizaciones sociales y es miembro del
                Consejo Directivo de Fundación Escolares. Ha desarrollado su
                carrera en el ámbito empresarial, especializándose en Logística
                y Consultoría de procesos. En paralelo, siempre tuvo diferentes
                roles en distintas organizaciones sociales: Asociación Civil
                María de las Cárceles, Fundación Arché y Fundación Red
                Comunidades Rurales. Fue docente en materias de grado de
                Ingeniería en la UBA, de posgrado de UTN- Fundación Andreani y
                en la Fundación Forge.
              </React.Fragment>
            }
          />
          <Integrante
